...
public class Paths {
    ...
    public static final String MIR_MARK_MATRIX_GZ = BASE_DIRECTORY + "/mirMark_rf_2578_42677.matrix.gz";
    ...
    public static final String MIRTARBASE = BASE_DIRECTORY + "/mirTarBase_2578_42677.matrix.gz";
}